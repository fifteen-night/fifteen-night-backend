...
public enum DeliveryException implements ExceptionType {
	...
	DELIVERY_ROUTE_NOT_FOUND(HttpStatus.NOT_FOUND, "배송 루트를 찾을 수 없습니다.", "E_DELIVERY_ROUTE_NOT_FOUND" ),
	DELIVERY_ROUTE_SEQUENCE_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 시퀀스를 찾을 수 없습니다.", "E_DELIVERY_ROUTE_SEQUENCE_NOT_FOUND" ),;

...
@Getter
@AllArgsConstructor
public class UpdateSequenceResponseDto {
	...
	public static UpdateSequenceResponseDto fromSequence(DeliveryRouteSequence deliveryRouteSequence) {

		return UpdateSequenceResponseDto.builder()

...
@Getter
@AllArgsConstructor
public class CreateSequenceResponseDto {
	...
	public static CreateSequenceResponseDto fromSequence(DeliveryRouteSequence deliveryRouteSequence) {

		return CreateSequenceResponseDto.builder()

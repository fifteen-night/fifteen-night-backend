...
@Getter
@AllArgsConstructor
public class GetAllSequenceResponseDto {
	...
	public static GetAllSequenceResponseDto fromSequence(DeliveryRouteSequence deliveryRouteSequence) {

		return GetAllSequenceResponseDto.builder()

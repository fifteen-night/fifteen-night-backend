...
public class DeliveryController {
	...
	public ResponseEntity<CommonResponse<GetDeliveryResponseDto>> getDelivery(
	...
	@PreAuthorize("hasAnyRole('MASTER' , 'HUB_MANAGER')")
	public ResponseEntity<CommonResponse<DeleteDeliveryResponseDto>> deleteDelivery(
		@PathVariable("deliveryId") UUID deliveryId) {
	...
	public ResponseEntity<CommonResponse<UpdateDeliveryResponseDto>> updateDelivery(
		...
		UpdateDeliveryResponseDto updateDeliveryResponseDto = deliveryService.updateDelivery(deliveryId,
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<CommonResponse<QueryAllDeliveriesResponseDto>> queryAllDeliveries(
		@PathVariable("deliveryManagerId") UUID deliveryManagerId) {

		QueryAllDeliveriesResponseDto queryAllDeliveriesResponseDto = deliveryService.getAllDeliveries(
			deliveryManagerId);

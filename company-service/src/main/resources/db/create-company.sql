INSERT INTO company.p_company (
    ...
    company_hub_id, company_manager_id, created_at, updated_at, is_deleted
      ...
      ('20000000-0000-0000-0000-000000000001', '테크코프', '서울특별시 강남구 테헤란로 123', 'SUPPLIER',
       '10000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000004', NOW(), NOW(), false),

      ('20000000-0000-0000-0000-000000000002', '이노비즈', '울산광역시 남구 중앙로 45', 'RECEIVER',
       '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000003', NOW(), NOW(), false);

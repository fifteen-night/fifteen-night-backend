...
--       ('7791cd04-29ef-49f3-8f53-5fd4290d6f11', FALSE, NOW(), 'delivery20', crypt('Test@1234', gen_salt('bf')), '배송20', 'U00000020', 'DELIVERY_MANAGER', '01010000020', 'delivery20@example.com');
    ('00000000-0000-0000-0000-000000000001', FALSE, NOW(), 'master', crypt('Test@1234', gen_salt('bf')), '마스터1', 'U11111111', 'MASTER', '01011112222', 'master@example.com'),
    ('00000000-0000-0000-0000-000000000002', FALSE, NOW(), 'master2', crypt('Test@1234', gen_salt('bf')), '마스터2', 'U222222222', 'MASTER', '01011112223', 'master2@example.com'),
    ('00000000-0000-0000-0000-000000000003', FALSE, NOW(), 'companymg1', crypt('Test@1234', gen_salt('bf')), '업체 담당자1', 'U33333333', 'COMPANY_MANAGER', '01011112224', 'companymg1@example.com'),
    ('00000000-0000-0000-0000-000000000004', FALSE, NOW(), 'companymg2', crypt('Test@1234', gen_salt('bf')), '업체 담당자2', 'U44444444', 'COMPANY_MANAGER', '01011112225', 'companymg2@example.com'),
    ('00000000-0000-0000-0000-000000000005', FALSE, NOW(), 'hubmng1', crypt('Test@1234', gen_salt('bf')), '허브 매니저1', 'U55555555', 'HUB_MANAGER', '01011112226', 'hubmng1@example.com'),
    ('00000000-0000-0000-0000-000000000006', FALSE, NOW(), 'hubmng2', crypt('Test@1234', gen_salt('bf')), '허브 매니저2', 'U66666666', 'HUB_MANAGER', '01011112227', 'hubmng2@example.com'),
    ('00000000-0000-0000-0000-000000000007', FALSE, NOW(), 'delivery1', crypt('Test@1234', gen_salt('bf')), '배송 담당자1', 'U77777777', 'DELIVERY_MANAGER', '01011112228', 'deliverymng1@example.com'),
    ('00000000-0000-0000-0000-000000000008', FALSE, NOW(), 'delivery2', crypt('Test@1234', gen_salt('bf')), '배송 담당자2', 'U88888888', 'DELIVERY_MANAGER', '01011112229', 'deliverymng2@example.com'),
    ('00000000-0000-0000-0000-000000000009', FALSE, NOW(), 'delivery3', crypt('Test@1234', gen_salt('bf')), '배송 담당자3', 'U88828888', 'DELIVERY_MANAGER', '01011112230', 'deliverymng3@example.com'),
    ('00000000-0000-0000-0000-000000000010', FALSE, NOW(), 'delivery4', crypt('Test@1234', gen_salt('bf')), '배송 담당자4', 'U99999999', 'DELIVERY_MANAGER', '01011112430', 'deliverymng4@example.com');
